...
{% hint style="info" %}
Fedora Workstation - це основна офіційна версія Fedora, яка пропонує користувачам стабільне середовище GNOME. Однак, тепер Fedora має ще одну офіційну редакцію з оточенням KDE Plasma - це **Fedora KDE Plasma Desktop**.
{% endhint %}

## **Де завантажити Fedora Linux?**

<figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption><p>Офіційний сайт fedora Linux</p></figcaption></figure>
