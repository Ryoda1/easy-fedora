...
### Повний контроль над GPU AMD

Для того, щоб мати повний контроль над вашою відеокартою AMD, використовуючи драйвер **amdgpu**, вам потрібно додати параметр завантаження **amdgpu.ppfeaturemask=0xffffffff** до конфігурації завантажувача та перезавантажити систему.

{% hint style="info" %}
**УВАГА:** Інструкції наведені для орієнтації. Перевірте документацію вашого дистрибутива щодо того, як додавати параметри завантаження.
{% endhint %}
